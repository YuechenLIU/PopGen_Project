# !/usr/bin/python
# Filename: IndoBengalAmur_LRT_Stdev_12Mig.py
...
p_lrt_1213Mig = [1.95667364, 0.59896642, 0.09989642, 0.50330380, 0.06868595, 0.50227995, 2.60881723, 0, 0]
adjust_1213Mig = dadi.Godambe.LRT_adjust(func_ex_1213Mig, pts_l, all_boot, p_lrt_1213Mig, data, nested_indices=[7,8], multinom=True)
D_adj_1213Mig = adjust_1213Mig*2*(ll_1213Mig - ll_12Mig)
p_val_1213Mig = dadi.Godambe.sum_chi2_ppf(D_adj_1213Mig, weights=(0, 1))
...
p_lrt_123Mig = [1.95667364, 0.59896642, 0.09989642, 0.50330380, 0.06868595, 0.50227995, 2.60881723, 0, 0, 0, 0]
adjust_123Mig = dadi.Godambe.LRT_adjust(func_ex_123Mig, pts_l, all_boot, p_lrt_123Mig, data, nested_indices=[7,8,9,10], multinom=True)
D_adj_123Mig = adjust_123Mig*2*(ll_123Mig - ll_12Mig)
p_val_123Mig = dadi.Godambe.sum_chi2_ppf(D_adj_123Mig, weights=(0, 0, 1))

# 12Mig:   nuIndo, nuBengal, nuAmur, T_IndoBengal, T_IndoAmur, mIndoBengal,  mBengalIndo,  mIndoBengal,  mBengalIndo
...
p_lrt_MidRates = [1.95667364, 0.59896642, 0.09989642, 0.50330380, 0.06868595, 0.50227995, 2.60881723, 0.50227995, 2.60881723, 0, 0]
...
D_adj_MidRates = adjust_MidRates*2*(ll_MidRates - ll_12Mig)
...
p_lrt_TwoRates = [1.95667364, 0.59896642, 0.09989642, 0.50330380, 0.06868595, 0.50227995, 2.60881723, 0.50227995, 2.60881723, 0, 0, 0, 0]
...
D_adj_TwoRates = adjust_TwoRates*2*(ll_TwoRates - ll_12Mig)
...
print
print('Adjusted D statistic of 1213Mig and 12Mig: {0:.4f}'.format(D_adj_1213Mig))
print('p-value for rejecting 12Mig: {0:.4f}'.format(p_val_1213Mig))
print
print('Adjusted D statistic of 123Mig and 12Mig: {0:.4f}'.format(D_adj_123Mig))
print('p-value for rejecting 12Mig: {0:.4f}'.format(p_val_123Mig))
print
print('Adjusted D statistic of MidRates and 12Mig: {0:.4f}'.format(D_adj_MidRates))
print('p-value for rejecting 12Mig: {0:.4f}'.format(p_val_MidRates))
print
print('Adjusted D statistic of TwoRates and 12Mig: {0:.4f}'.format(D_adj_TwoRates))
print('p-value for rejecting 12Mig: {0:.4f}'.format(p_val_TwoRates))
