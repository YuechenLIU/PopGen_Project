# !/usr/bin/python
# Filename: IndoBengalMalay_LRT_Stdev_13Mig.py
...
p_lrt_1213Mig = [1.86997707, 0.76421945, 0.09028367, 0.13613753, 0.03313133, 0, 0, 0.00000000, 8.44732062]
adjust_1213Mig = dadi.Godambe.LRT_adjust(func_ex_1213Mig, pts_l, all_boot, p_lrt_1213Mig, data, nested_indices=[5,6], multinom=True)
D_adj_1213Mig = adjust_1213Mig*2*(ll_1213Mig - ll_13Mig)
...
p_lrt_123Mig = [1.86997707, 0.76421945, 0.09028367, 0.13613753, 0.03313133, 0, 0, 0.00000000, 8.44732062, 0, 0]
adjust_123Mig = dadi.Godambe.LRT_adjust(func_ex_123Mig, pts_l, all_boot, p_lrt_123Mig, data, nested_indices=[5,6,9,10], multinom=True)
D_adj_123Mig = adjust_123Mig*2*(ll_123Mig - ll_13Mig)
...
p_lrt_MidRates = [1.86997707, 0.76421945, 0.09028367, 0.13613753, 0.03313133, 0, 0, 0, 0, 0.00000000, 8.44732062]
...
D_adj_MidRates = adjust_MidRates*2*(ll_MidRates - ll_13Mig)
...
p_lrt_TwoRates = [1.86997707, 0.76421945, 0.09028367, 0.13613753, 0.03313133, 0, 0, 0, 0, 0.00000000, 8.44732062, 0, 0]
...
D_adj_TwoRates = adjust_TwoRates*2*(ll_TwoRates - ll_13Mig)
...
print
print('Adjusted D statistic of 1213Mig and 13Mig: {0:.4f}'.format(D_adj_1213Mig))
print('p-value for rejecting 13Mig: {0:.4f}'.format(p_val_1213Mig))
print
print('Adjusted D statistic of 123Mig and 13Mig: {0:.4f}'.format(D_adj_123Mig))
print('p-value for rejecting 13Mig: {0:.4f}'.format(p_val_123Mig))
print
print('Adjusted D statistic of MidRates and 13Mig: {0:.4f}'.format(D_adj_MidRates))
print('p-value for rejecting 13Mig: {0:.4f}'.format(p_val_MidRates))
print
print('Adjusted D statistic of TwoRates and 13Mig: {0:.4f}'.format(D_adj_TwoRates))
print('p-value for rejecting 13Mig: {0:.4f}'.format(p_val_TwoRates))
