# !/usr/bin/python
# Filename: IndoSumatranBengal_noMig.py
...
"""A python script to simulation the demographic model among Indochinese, Sumatran, and Bengal populations.
   ...
   2ed split between Bengal vs. Indochinese groups.
"""
...
pts_l = [30,40,50]
func = IndoSumatranBengal_noMig

#parameters:  [nuIndo,nuSumatran,nuBengal,T_IndoSumatran,T_IndoBengal]
upper_bound = [10,	5,	5,	1,	5]	# changed
lower_bound = [0.01,    0.01,   0.01,   0.00,	0.00]	# changed
p0          = [1.97,	0.20,	0.72,	0.01,	0.16]	# changed
